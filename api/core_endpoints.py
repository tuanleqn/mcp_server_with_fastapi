...
async def get_simple_chart_data(
    ...
    try:
        ...
        if price_data.get("success"):
            ...
            open_price = price_data.get("open_price", base_price * 0.995)
            high_price = price_data.get("high_price", base_price * 1.02)
            low_price = price_data.get("low_price", base_price * 0.98)
        else:
        ...
        start_hour = 9
        start_minute = 30
        interval_minutes = (7 * 60) // points  # Spread across 7 hours
        ...
        return {
            ...
            "timestamp": datetime.now().isoformat(),
            "dataPoints": len(chart_data),
            "dataSource": "real" if price_data.get("success") else "mock"
        }
